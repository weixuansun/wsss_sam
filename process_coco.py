...
if __name__ == "__main__":
    ...
    parser.add_argument("--img_list", type=str, required=True, default='metadata/coco/train_02.txt')
    # parser.add_argument("--text_prompt", type=str, required=True, help="text prompt")
    parser.add_argument(
        "--output_dir", "-o", type=str, default="outputs", required=True, help="output directory"
    )

    parser.add_argument("--im_path", default="/home/notebook/data/personal/S9050086/coco/train2014/", type=str)
    ...
    for index, i in enumerate(img_list):
        ...
        image_path = os.path.join(args.im_path, i + '.jpg')
        ...
        # get text prompt
        text_prompt_list = get_coco_gt(name)
        ...
        except: # in case nothing is detected
            masks = []
        ...
        pseudo = save_mask_data(output_dir, masks, boxes_filt, pred_phrases, name, H, W)
        plt.close()
